...
public class HTMLReporter extends TestListenerAdapter implements IReporter
{
    ...
    private void startHtmlPage(PrintWriter out)
    {
        ...
        out.println("<head>");
        out.println("<title>Loyed QA Automation Test Results Summary</title>");
        out.println("</head>");
        out.println("<body><div style=\"margin:0 auto; padding:15px; min-height:450px; min-width: 450px; height:auto;\">"
                ...
                + "<h1 style=\"background-color: #93b874; color: white; text-align: center; font-family: Georgia;\">Loyed QA Automation Report</h1>");
    ...
    {
        out.println("<br/><br/><div align=\"right\"> &copy; <a href=\"http://www.loyed.com\">2018 Loyed Bank.</a></div>");
